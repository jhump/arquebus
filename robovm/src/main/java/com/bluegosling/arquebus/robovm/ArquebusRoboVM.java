package com.bluegosling.arquebus.robovm;
...
public class ArquebusRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, ArquebusRoboVM.class);
    pool.close();
  }
}
